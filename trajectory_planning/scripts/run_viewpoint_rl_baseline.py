...
from trajectory_planning.viewpoint_rl_env import run_greedy_baseline  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the greedy viewpoint baseline through an RL-style environment.")
    ...
    parser.add_argument("--seed", type=int, default=17, help="Random seed for deterministic downsampling.")
    parser.add_argument("--no-two-opt", action="store_true", help="Keep the raw policy rollout order without 2-opt shortening.")
...
def main() -> int:
    ...
    selected_rows, summary = run_greedy_baseline(
        candidates,
        point_features,
        config,
    ...
    print(f"surface_points={summary['surface_point_count']}")
