...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Select and order camera/endoscope viewpoints from candidates.")
    ...
    parser.add_argument("--output-json", type=Path, help="Optional selection summary JSON.")
...
def main() -> int:
    ...
    selected_rows, summary = select_viewpoints(candidates, point_features, config)
