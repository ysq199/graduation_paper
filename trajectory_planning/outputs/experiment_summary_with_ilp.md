...
| name | baseline | selected_view_count | coverage_ratio | weighted_coverage_ratio | path_cost_after_2opt | reward_motion_scale | reward_local_jump_threshold | reward_local_jump_scale | reward_smoothness_scale | reward_region_switch_scale | ga_generations | ga_path_weight | ilp_time_limit | ilp_mip_gap | ilp_solver_success |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
